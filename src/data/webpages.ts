...
export const communityPageCollections = defineCollection({
	async loader() {
		...
		return res.items.map((data) => ({
			...
			moneyWitFinancialStepThreeTitle:
				data.fields.moneyWitFinancialStepThreeTitle,
			moneyWitFinancialStepThreeDesc:
				data.fields.moneyWitFinancialStepThreeDesc,
			moneyWitFinancialStepFourTitile:
				data.fields.moneyWitFinancialStepFourTitile,
