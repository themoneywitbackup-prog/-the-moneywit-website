...
export const products: Product[] = [
  {
    ...
    short: "The plug-and-play planner the Money Wit team uses built by a CFA Charterholder, not a spreadsheet expert.",
    ...
    href: "https://themoneywit.africa/school/financial-planning-tool/",
    cta: "Get the Tool",
    featured: true,
  },
  {
  ...
  },
  {
    ...
    priceNumeric: 300000,
    image: beatTheOdds,
    href: "https://themoneywit.africa/school/beat-the-odds/",
  ...
  },
  {
    ...
    description: "A structured course that removes the guesswork from investing. Learn how to pick instruments that match your goals, allocate across all markets.",
    price: "NGN 20,000",
    priceNumeric: 20000,
    image: whereAndHowToInvest,
    href: "https://themoneywit.africa/school/where-and-how-to-invest/",
    cta: "Buy Course",
    featured: true,
  },
  {
    ...
    href: "https://themoneywit.africa/school/personal-finance-lab/",
    cta: "Enter the Lab",
    featured: true,
  },
  {
    ...
    short: "A one-on-one working session on your cashflow, debt, investments and goals with a CFA Charterholder.",
    ...
    href: "https://forms.zoho.com/oleroladelecom/form/CONTACTUS",
    cta: "Book a Session",
  },
];
...
export const bundles: Bundle[] = [
  {
    ...
    price: "NGN 23,000",
    href: "https://zohosecurepay.com/checkout/l7i782b-o2bo0khqc33zo/FINANCIAL-PLANNING--INVESTING-BUNDLE",
    cta: "Get the Bundle",
  },
  {
    id: "complete-starter",
    ...
    price: "NGN 23,000",
    href: "https://zohosecurepay.com/checkout/q4v4pzs-jngjy2kt8110f/COMPLETE-FINANCIAL-STARTER-BUNDLE",
    cta: "Get the Bundle",
  },
];
